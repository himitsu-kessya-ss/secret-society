...
const initialMembers = [
    { id: 1, badge: "❄️🦊", name: "Oro🍊min", machine: "ブリッツガンダム虚無空間", lastMonth: 36319, thisMonth: 94125, total: 130444, adjustment: 0 },
    { id: 2, badge: "🚢🚢", name: "キュゥべえ（提督）", machine: "ガンダイバー", lastMonth: 22615, thisMonth: 41550, total: 64165, adjustment: 0 },
    ...
    { id: 14, badge: "🔥💥", name: "シン・アスカ", machine: "フォビドゥンブルー(強襲形態)あんこう", lastMonth: 1263, thisMonth: 54672, total: 55935, adjustment: 0 },
    ...
    { id: 21, badge: "🔰🔰", name: "Halbert", machine: "ガンダイバーHalbert", lastMonth: 0, thisMonth: 13, total: 13, adjustment: 0 }
];

const initialHistory = [
    { year: 2026, date: "8/31", totalP: 100576, monthlyP: 100576, rate: 100.0, members: [36319, 22615, 4115, 668, 8406, 73, 327, 2900, 5722, 106, 14491, 29, 21, 1263, 5, 37, 3456, 23, 0, 0, 0] },
    { year: 2026, date: "9/30", totalP: 155210, monthlyP: 54634, rate: 100.0, members: [94125, 41550, 7338, 575, 29808, 182, 63742, 21214, 198, 21936, 34059, 73, 87, 54672, 81, 129, 544, 19292, 747, 88, 13] }
];
